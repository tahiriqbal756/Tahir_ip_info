...
clear
echo -e "\e[1;32m🚀 Installing Tahir IP Info Tool...\e[0m"
pkg update && pkg upgrade -y
pkg install python -y
pip install requests pyfiglet termcolor

echo -e "\e[1;34m✅ Creating Tahir IP Info Script...\e[0m"
cat <<EOF > tahir-ipinfo.py
import requests
import pyfiglet
import webbrowser
...
echo -e "\e[1;32m✅ Installation Complete! Run the tool using: python tahir-ipinfo.py\e[0m"
